...
Refinery::Resources.configure do |config|
  ...
  # config.dragonfly_secret = "b26822f4e6a1d759c5abe46dc539fcf0947d16dd2638430b"
  config.dragonfly_url_format = "/system/resources/:job/:basename.:ext"
  config.dragonfly_url_host = Rails.application.config.action_controller.asset_host
  # config.datastore_root_path = "/Users/andy/repos/jordan_michaelides/public/system/refinery/resources"
